...
public class Magnum : BaseWeapon
{
    [HideInInspector]
    public Inventory.AmmunitionStorage.MagnumRounds ammoStorage { get; private set; }
    Transform muzzle;
    ...
    void Start()
    {
        ...
        ammoStorage = Inventory.ammoStorage.magnumRounds;
