...
namespace Manoeuvre
{
    ...
    public class ManoeuvreFPSControllerEditor : Editor
    {
        ...
        void DrawLocomotionProperties()
        {
            ...
            float walkSpeed = EditorGUILayout.Slider("Walk Speed ", _Controller.Locomotion.walkSpeed, 0.1f,20f);
            float crouchSpeed = EditorGUILayout.Slider("Crouch Speed ", _Controller.Locomotion.crouchSpeed, 0.1f,20f);
            float runSpeed = EditorGUILayout.Slider("Run Speed ", _Controller.Locomotion.runSpeed, 0.1f,50f);
            float jumpSpeed = EditorGUILayout.Slider("Jump Speed ", _Controller.Locomotion.jumpSpeed, 0.1f,30f);
            float fallSpeed = EditorGUILayout.Slider("Fall Speed ", _Controller.Locomotion.fallSpeed, 0.1f,30f);
            float gravityEffector = EditorGUILayout.Slider("Gravity Speed ", _Controller.Locomotion.gravityEffector, 0.1f,30f);
